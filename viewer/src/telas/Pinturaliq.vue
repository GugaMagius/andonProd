<template>
  <div>
    ...
    :tamTxtO="tamTxtO"
    :tamTxtH="tamTxtH"
    :produzidos="produzidosPL"
    :perdidos="perdidosPL"
    :ecoat="false"
    :unidMedia="'(m2/h)'"
    :unidQtd="'(m2)'"
    :metaP="produzidosPL.metaP_PL"
    :sufixoMeta="' m2/h'"
    :alturaGraficoH='3'
    :alturaGraficoO='2'
    :larguraGraficoH='5'
...
export default {
  ...
  mounted() {
    ...
    if (this.dadosServer.AtualizaDadosPL != undefined) {
      this.produzidosPL = this.dadosServer.AtualizaDadosPL;
 ...
 watch: {
  ...
  sockets: {
    ...
    AtualizaDados(dados) {
      try {
        if (dados.AtualizaDadosPL != undefined) {
          this.produzidosPL = dados.AtualizaDadosPL;
