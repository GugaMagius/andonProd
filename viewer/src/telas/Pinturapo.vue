<template>
  <div>
    ...
    :tamTxtO="tamTxtO"
    :tamTxtH="tamTxtH"
    :produzidos="produzidosPP"
    :perdidos="perdidosPP"
    :ecoat="false"
    :unidMedia="'(m2/h)'"
    :unidQtd="'(m2)'"
    :metaP="produzidosPP.metaP_PP"
    :sufixoMeta="' m2/h'"
    :alturaGraficoH='3'
    :alturaGraficoO='2'
    :larguraGraficoH='5'
...
export default {
  ...
  mounted() {
    ...
    if (this.dadosServer.AtualizaDadosPP != undefined) {
      this.produzidosPP = this.dadosServer.AtualizaDadosPP;
  ...
  sockets: {
    ...
    AtualizaDados(dados) {
      try {
        if (dados.AtualizaDadosPP != undefined) {
          this.produzidosPP = dados.AtualizaDadosPP;
